 ...
 *
 * 注意： 这里搜索是根据代价函数 （这里是 距离矩阵） 来计算的，
 * 这里距离矩阵已预计算给出， （注意这里是图搜索）， 搜索路径
 * 还受制于 禁止搜索点集
 *
 */
public class Ant implements Cloneable{

    private Vector<Integer> tabu ;   // 紧急表
    ...
    private int firstCity ;   //  原点
    private int currentCity;    // 当前点
    ...
    public void init(int[][] distance,float a,float b) {
        ...
        delta = new float[cityNum][cityNum];   // 信息素矩阵
