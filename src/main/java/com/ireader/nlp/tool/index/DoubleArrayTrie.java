package com.ireader.nlp.tool.index;
...
public class DoubleArrayTrie {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("/home/zxsted/data/small.dic"));
        ...
        // 如果字典要加入新的词， 需要按照字典序重新排列，然后生成字典文件
     /* Collections.sort(words);
       ...
       */
        ...
        System.out.println("错误：" + dat.build(words));
        ...
        // 精确匹配 ： 给出确切 字典索引位置
        int ix = dat.exactMatchSearch("万能");
