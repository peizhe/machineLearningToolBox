...
public class SoftMaxLayer {
    ...
    public SoftMaxLayer(int n_in,int n_out){

        setSize(n_in,n_out);

    }

    public SoftMaxLayer setSize(int n_in,int n_out) {
...
//        }
    ...
    /** ============ setter and getter ==================================================*/
    public SoftMaxLayer setdWMat(double[][] dWMat) {
        this.dWMat = dWMat;
        return this;
    }

    public SoftMaxLayer setwMat(double[][] wMat) {
        this.wMat = wMat;
        return this;
    }

    public SoftMaxLayer setBias(double[] bias) {
        this.bias = bias;
        return this;
    }

    public SoftMaxLayer setDb(double[] db) {
        this.dbias = db;
        return this;
    }

    public SoftMaxLayer setNout(int nout) {
        this.nout = nout;
        return this;
    }

    public SoftMaxLayer setNin(int nin) {
        this.nin = nin;
        return this;
    }

    public SoftMaxLayer setNormal(String normal) {
        this.normal = normal;
        return this;
    }

    public SoftMaxLayer setLambd(double lambd) {
        this.lambd = lambd;
        return this;
    }

    public SoftMaxLayer setLr(double lr) {
        this.lr = lr;
        return this;
    }
}
